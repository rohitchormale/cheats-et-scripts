...
gunicorn -c /etc/gunicorn/gunicorn_config.py rungun:application

or

gunicorn --pythonpath '/opt/mysite/'\
 --access-logfile /var/log/gunicorn/access_log\
 --pid /var/run/gunicorn.pid\
 --error-logfile /var/log/gunicorn/error_log\
 --log-level debug
 --daemon --bind '127.0.0.1:8000'\
